define({
    ...
    '<div class="btn-group navbar-right btn-group-condensed my-account-nav">' +
        '<m-link href="/apps/my/User/Notifications" data-toggle="tooltip" data-container="body" data-original-title="Notificaciones" data-placement="bottom" class="btn btn-default btn-sm navbar-btn">' +
            '<i class="glyphicon glyphicon-info-sign"></i> <span class="label label-info">{{notificationCount}}</span></m-link>' +
        '<m-link href="/apps/my/User/Messages/FindMessage?statusId=CeReceived&toCurrentUser=true" data-toggle="tooltip" data-container="body" data-original-title="Mensajes" data-placement="bottom" class="btn btn-default btn-sm navbar-btn">' +
            '<i class="glyphicon glyphicon-envelope"></i> <span class="label label-warning">{{messageCount}}</span></m-link>' +
        '<m-link href="/apps/my/User/Calendar/MyCalendar" data-toggle="tooltip" data-container="body" data-original-title="Eventos Esta Semana" data-placement="bottom" class="btn btn-default btn-sm navbar-btn">' +
            '<i class="glyphicon glyphicon-calendar"></i> <span class="label label-primary">{{eventCount}}</span></m-link>' +
        '<m-link href="/apps/my/User/Task/MyTasks" data-toggle="tooltip" data-container="body" data-original-title="Tareas Abiertas" data-placement="bottom" class="btn btn-default btn-sm navbar-btn">' +
